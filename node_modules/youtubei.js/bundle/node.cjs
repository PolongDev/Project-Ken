...
var CommentThread = class extends YTNode {
  ...
  getContinuation() {
    ...
    return (0, import_tslib5.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_actions, "f"))
        throw new InnertubeError("Actions instance not set for this thread.");
      const load_more_button = (_a4 = (0, import_tslib5.__classPrivateFieldGet)(this, _CommentThread_continuation, "f").button) === null || _a4 === void 0 ? void 0 : _a4.as(Button_default);
      if (!load_more_button)
...
_MusicResponsiveListItem_playlist_item_data = /* @__PURE__ */ new WeakMap(), _MusicResponsiveListItem_instances = /* @__PURE__ */ new WeakSet(), _MusicResponsiveListItem_parseOther = /* @__PURE__ */ __name(function _MusicResponsiveListItem_parseOther2() {
  ...
  this.id = (0, import_tslib6.__classPrivateFieldGet)(this, _MusicResponsiveListItem_playlist_item_data, "f").video_id || ((_b2 = (_a4 = this.endpoint) === null || _a4 === void 0 ? void 0 : _a4.payload) === null || _b2 === void 0 ? void 0 : _b2.videoId);
  this.title = this.flex_columns.first().title.toString();
...
function createRuntimeClass(classname, key_info, logger) {
  ...
  const node = (_a4 = /* @__PURE__ */ __name(class extends YTNode {
    static set key_info(key_info2) {
      (0, import_tslib8.__classPrivateFieldSet)(this, _a4, new Map(key_info2), "f", _key_info);
    }
    static get key_info() {
      return [...(0, import_tslib8.__classPrivateFieldGet)(this, _a4, "f", _key_info).entries()];
    }
    constructor(data) {
      super();
  ...
  }, "_a"), (0, import_tslib8.__setFunctionName)(_a4, "node"), _a4.type = classname, _key_info = { value: /* @__PURE__ */ new Map() }, _a4);
...
var ERROR_HANDLER = /* @__PURE__ */ __name((_a4) => {
  var { classname } = _a4, context = (0, import_tslib9.__rest)(_a4, ["classname"]);
...
var Analytics = class {
  constructor(response) {
    ...
    this.sections = (_a4 = (0, import_tslib11.__classPrivateFieldGet)(this, _Analytics_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(Element_default).map((el) => el.model).flatMap((el) => !el ? [] : el);
  }
  get page() {
...
var Feed = class {
  ...
  get page_contents() {
    var _a4;
    const tab_content = (_a4 = (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_memo, "f").getType(Tab_default)) === null || _a4 === void 0 ? void 0 : _a4.first().content;
  ...
  get secondary_contents() {
    var _a4, _b2;
    if (!((_a4 = (0, import_tslib12.__classPrivateFieldGet)(this, _Feed_page, "f").contents) === null || _a4 === void 0 ? void 0 : _a4.is_node))
      return void 0;
...
var TabbedFeed = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    (0, import_tslib13.__classPrivateFieldSet)(this, _TabbedFeed_tabs, (_a4 = this.page.contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(Tab_default), "f");
  }
  get tabs() {
    var _a4, _b2;
    return (_b2 = (_a4 = (0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a4 === void 0 ? void 0 : _a4.map((tab) => tab.title.toString())) !== null && _b2 !== void 0 ? _b2 : [];
  }
  getTabByName(title) {
    var _a4;
    return (0, import_tslib13.__awaiter)(this, void 0, void 0, function* () {
      const tab = (_a4 = (0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a4 === void 0 ? void 0 : _a4.find((tab2) => tab2.title.toLowerCase() === title.toLowerCase());
      if (!tab)
  ...
  getTabByURL(url) {
    var _a4;
    return (0, import_tslib13.__awaiter)(this, void 0, void 0, function* () {
      const tab = (_a4 = (0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a4 === void 0 ? void 0 : _a4.find((tab2) => {
        var _a5;
  ...
  hasTabWithURL(url) {
    var _a4, _b2;
    return (_b2 = (_a4 = (0, import_tslib13.__classPrivateFieldGet)(this, _TabbedFeed_tabs, "f")) === null || _a4 === void 0 ? void 0 : _a4.some((tab) => {
      var _a5;
...
var Comments = class {
  constructor(actions, data, already_parsed = false) {
    ...
    this.contents = observe(threads.map((thread) => {
      var _a5;
      (_a5 = thread.comment) === null || _a5 === void 0 ? void 0 : _a5.setActions((0, import_tslib16.__classPrivateFieldGet)(this, _Comments_actions, "f"));
...
var Guide = class {
  constructor(data) {
    ...
    (0, import_tslib17.__classPrivateFieldSet)(this, _Guide_page, parser_exports.parseResponse(data), "f");
...
var Playlist2 = class extends Feed_default {
  constructor(actions, data, already_parsed = false) {
    ...
    this.info = Object.assign(Object.assign({}, (_b2 = this.page.metadata) === null || _b2 === void 0 ? void 0 : _b2.item().as(PlaylistMetadata_default)), {
...
var LiveChat2 = class extends EventEmitterLike_default {
  constructor(video_info) {
    ...
    (0, import_tslib26.__classPrivateFieldSet)(this, _LiveChat_continuation, (_a4 = video_info.livechat) === null || _a4 === void 0 ? void 0 : _a4.continuation, "f");
  ...
  sendMessage(text) {
    return (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_actions, "f").execute("/live_chat/send_message", {
        params: encodeMessageParams((0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_channel_id, "f"), (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_video_id, "f")),
...
_LiveChat_actions = /* @__PURE__ */ new WeakMap(), _LiveChat_video_id = /* @__PURE__ */ new WeakMap(), _LiveChat_channel_id = /* @__PURE__ */ new WeakMap(), _LiveChat_continuation = /* @__PURE__ */ new WeakMap(), _LiveChat_mcontinuation = /* @__PURE__ */ new WeakMap(), _LiveChat_retry_count = /* @__PURE__ */ new WeakMap(), _LiveChat_instances = /* @__PURE__ */ new WeakSet(), _LiveChat_pollLivechat = /* @__PURE__ */ __name(function _LiveChat_pollLivechat2() {
  (() => (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
    ...
    try {
      ...
      this.emit("error", err);
      if (((0, import_tslib26.__classPrivateFieldSet)(this, _LiveChat_retry_count, (_b2 = (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_retry_count, "f"), _a4 = _b2++, _b2), "f"), _a4) < 10) {
        yield (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_wait).call(this, 2e3);
        (0, import_tslib26.__classPrivateFieldGet)(this, _LiveChat_instances, "m", _LiveChat_pollLivechat2).call(this);
      } else {
  ...
  (() => (0, import_tslib26.__awaiter)(this, void 0, void 0, function* () {
    ...
    try {
      ...
      (0, import_tslib26.__classPrivateFieldSet)(this, _LiveChat_mcontinuation, (_a4 = data.continuation) === null || _a4 === void 0 ? void 0 : _a4.token, "f");
      this.metadata = {
...
var Settings = class {
  constructor(actions, response) {
    ...
    this.sidebar = (_a4 = (0, import_tslib29.__classPrivateFieldGet)(this, _Settings_page, "f").sidebar) === null || _a4 === void 0 ? void 0 : _a4.as(SettingsSidebar_default);
...
var UniversalCache = class {
  constructor(persistent, persistent_directory) {
    ...
    (0, import_tslib32.__classPrivateFieldSet)(this, _UniversalCache_cache, new Platform.shim.Cache(persistent, persistent_directory), "f");
  }
  get cache_dir() {
    return (0, import_tslib32.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").cache_dir;
  }
  get(key) {
    return (0, import_tslib32.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").get(key);
  }
  set(key, value) {
    return (0, import_tslib32.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").set(key, value);
  }
  remove(key) {
    return (0, import_tslib32.__classPrivateFieldGet)(this, _UniversalCache_cache, "f").remove(key);
  }
};
...
var HTTPClient = class {
  constructor(session, cookie, fetch) {
    ...
    (0, import_tslib33.__classPrivateFieldSet)(this, _HTTPClient_session, session, "f");
    (0, import_tslib33.__classPrivateFieldSet)(this, _HTTPClient_cookie, cookie, "f");
    (0, import_tslib33.__classPrivateFieldSet)(this, _HTTPClient_fetch, fetch || Platform.shim.fetch, "f");
  }
  get fetch_function() {
    return (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_fetch, "f");
  }
  fetch(input, init) {
    return (0, import_tslib33.__awaiter)(this, void 0, void 0, function* () {
      const innertube_url = URLS.API.PRODUCTION_1 + (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_session, "f").api_version;
      ...
      request_headers.set("X-Goog-Visitor-Id", (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_session, "f").context.client.visitorData || "");
      request_headers.set("X-Origin", request_url.origin);
      request_headers.set("X-Youtube-Client-Version", (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_session, "f").context.client.clientVersion || "");
      if (Platform.shim.server) {
        request_headers.set("User-Agent", getRandomUserAgent("desktop"));
        request_headers.set("origin", request_url.origin);
      }
      request_url.searchParams.set("key", (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_session, "f").key);
      ...
      if (content_type === "application/json" && is_innertube_req && typeof body === "string") {
        ...
        const n_body = Object.assign(Object.assign({}, json), {
          context: JSON.parse(JSON.stringify((0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_session, "f").context))
        });
        (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_instances, "m", _HTTPClient_adjustContext).call(this, n_body.context, n_body.client);
      ...
      if ((0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_session, "f").logged_in && is_innertube_req && !is_web_kids) {
        const oauth = (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_session, "f").oauth;
        ...
        if ((0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_cookie, "f")) {
          const papisid = getStringBetweenStrings((0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_cookie, "f"), "PAPISID=", ";");
          if (papisid) {
            request_headers.set("authorization", yield generateSidAuth(papisid));
            request_headers.set("x-goog-authuser", (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_session, "f").account_index.toString());
          }
          request_headers.set("cookie", (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_cookie, "f"));
        }
      }
      const request = new Platform.shim.Request(request_url, input instanceof Platform.shim.Request ? input : init);
      const response = yield (0, import_tslib33.__classPrivateFieldGet)(this, _HTTPClient_fetch, "f").call(this, request, {
        body: request_body,
...
function DashManifest({ streamingData, transformURL, rejectFormat, cpn, player, actions, storyboards }) {
  ...
  return createElement(
    ...
    createElement(
      ...
      image_sets.map((set, index) => (0, import_tslib35.__awaiter)(this, void 0, void 0, function* () {
        return createElement("adaptation-set", { id: index + audio_sets.length + video_sets.length, mimeType: yield set.getMimeType(), contentType: "image" }, set.representations.map((rep) => (0, import_tslib35.__awaiter)(this, void 0, void 0, function* () {
          return createElement(
            "representation",
        ...
        return new Promise((resolve, reject) => (0, import_tslib36.__awaiter)(this, void 0, void 0, function* () {
          ...
          try {
            ...
            if (!body)
              throw new InnertubeError("Could not get ReadableStream from fetch Response.", { error_type: "FETCH_FAILED", response });
            try {
              for (var _d = true, _e = (0, import_tslib36.__asyncValues)(streamToIterable(body)), _f; _f = yield _e.next(), _a4 = _f.done, !_a4; _d = true) {
                _c = _f.value;
                _d = false;
                const chunk = _c;
...
var TranscriptInfo = class {
  constructor(actions, response) {
    ...
    (0, import_tslib37.__classPrivateFieldSet)(this, _TranscriptInfo_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib37.__classPrivateFieldSet)(this, _TranscriptInfo_actions, actions, "f");
    this.transcript = (0, import_tslib37.__classPrivateFieldGet)(this, _TranscriptInfo_page, "f").actions_memo.getType(Transcript_default).first();
  }
  selectLanguage(language) {
    var _a4, _b2, _c, _d;
    return (0, import_tslib37.__awaiter)(this, void 0, void 0, function* () {
      const target_menu_item = (_d = (_c = (_b2 = (_a4 = this.transcript.content) === null || _a4 === void 0 ? void 0 : _a4.footer) === null || _b2 === void 0 ? void 0 : _b2.language_menu) === null || _c === void 0 ? void 0 : _c.sub_menu_items) === null || _d === void 0 ? void 0 : _d.find((item) => item.title.toString() === language);
      if (!target_menu_item)
        throw new Error(`Language not found: ${language}`);
      if (target_menu_item.selected)
        return this;
      const response = yield (0, import_tslib37.__classPrivateFieldGet)(this, _TranscriptInfo_actions, "f").execute("/get_transcript", {
        params: target_menu_item.continuation
      });
      return new TranscriptInfo((0, import_tslib37.__classPrivateFieldGet)(this, _TranscriptInfo_actions, "f"), response);
    });
  }
  get languages() {
    var _a4, _b2, _c, _d;
    return ((_d = (_c = (_b2 = (_a4 = this.transcript.content) === null || _a4 === void 0 ? void 0 : _a4.footer) === null || _b2 === void 0 ? void 0 : _b2.language_menu) === null || _c === void 0 ? void 0 : _c.sub_menu_items) === null || _d === void 0 ? void 0 : _d.map((item) => item.title.toString())) || [];
  }
  get selectedLanguage() {
    var _a4, _b2, _c, _d, _e;
    return ((_e = (_d = (_c = (_b2 = (_a4 = this.transcript.content) === null || _a4 === void 0 ? void 0 : _a4.footer) === null || _b2 === void 0 ? void 0 : _b2.language_menu) === null || _c === void 0 ? void 0 : _c.sub_menu_items) === null || _d === void 0 ? void 0 : _d.find((item) => item.selected)) === null || _e === void 0 ? void 0 : _e.title.toString()) || "";
  }
  get page() {
    return (0, import_tslib37.__classPrivateFieldGet)(this, _TranscriptInfo_page, "f");
  }
};
...
var MediaInfo = class {
  constructor(data, actions, cpn) {
    ...
    (0, import_tslib38.__classPrivateFieldSet)(this, _MediaInfo_actions, actions, "f");
    ...
    (0, import_tslib38.__classPrivateFieldSet)(this, _MediaInfo_page, [info, next], "f");
    (0, import_tslib38.__classPrivateFieldSet)(this, _MediaInfo_cpn, cpn, "f");
    if (((_b2 = info.playability_status) === null || _b2 === void 0 ? void 0 : _b2.status) === "ERROR")
      throw new InnertubeError("This video is unavailable", info.playability_status);
    this.streaming_data = info.streaming_data;
    this.playability_status = info.playability_status;
    (0, import_tslib38.__classPrivateFieldSet)(this, _MediaInfo_playback_tracking, info.playback_tracking, "f");
  }
  toDash(url_transformer, format_filter, options = { include_thumbnails: false }) {
    ...
    return (0, import_tslib38.__awaiter)(this, void 0, void 0, function* () {
      let storyboards;
      if (options.include_thumbnails && ((_a4 = (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards) === null || _a4 === void 0 ? void 0 : _a4.is(PlayerStoryboardSpec_default))) {
        storyboards = (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards;
      }
      return toDash(this.streaming_data, url_transformer, format_filter, (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f"), (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), storyboards);
    });
  }
  getStreamingInfo(url_transformer, format_filter) {
    var _a4;
    return getStreamingInfo(this.streaming_data, url_transformer, format_filter, this.cpn, (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), ((_a4 = (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards) === null || _a4 === void 0 ? void 0 : _a4.is(PlayerStoryboardSpec_default)) ? (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_page, "f")[0].storyboards : void 0);
  }
  ...
  download(options = {}) {
    return (0, import_tslib38.__awaiter)(this, void 0, void 0, function* () {
      return download(options, (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_actions, "f"), this.playability_status, this.streaming_data, (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").session.player, this.cpn);
    });
  }
  getTranscript() {
    var _a4;
  ...
  addToWatchHistory(client_name = CLIENTS.WEB.NAME, client_version = CLIENTS.WEB.VERSION, replacement = "https://www.") {
    return (0, import_tslib38.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_playback_tracking, "f"))
        throw new InnertubeError("Playback tracking not available");
      const url_params = {
        cpn: (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f"),
        fmt: 251,
        rtn: 0,
        rt: 0
      };
      const url = (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_playback_tracking, "f").videostats_playback_url.replace("https://s.", replacement);
      const response = yield (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_actions, "f").stats(url, {
        client_name,
        client_version
      }, url_params);
      return response;
  ...
  get actions() {
    return (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_actions, "f");
  }
  get cpn() {
    return (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_cpn, "f");
  }
  get page() {
    return (0, import_tslib38.__classPrivateFieldGet)(this, _MediaInfo_page, "f");
  }
};
  ...
  constructor(data, actions, cpn) {
    ...
    if (results && secondary_results) {
      ...
      if (this.watch_next_feed && Array.isArray(this.watch_next_feed) && ((_5 = this.watch_next_feed.at(-1)) === null || _5 === void 0 ? void 0 : _5.is(ContinuationItem_default)))
        (0, import_tslib39.__classPrivateFieldSet)(this, _VideoInfo_watch_next_continuation, (_6 = this.watch_next_feed.pop()) === null || _6 === void 0 ? void 0 : _6.as(ContinuationItem_default), "f");
...
var Album = class {
  constructor(response) {
    ...
    (0, import_tslib40.__classPrivateFieldSet)(this, _Album_page, parser_default.parseResponse(response.data), "f");
    this.header = (_a4 = (0, import_tslib40.__classPrivateFieldGet)(this, _Album_page, "f").header) === null || _a4 === void 0 ? void 0 : _a4.item().as(MusicDetailHeader_default);
    this.url = ((_b2 = (0, import_tslib40.__classPrivateFieldGet)(this, _Album_page, "f").microformat) === null || _b2 === void 0 ? void 0 : _b2.as(MicroformatData_default).url_canonical) || null;
    if (!(0, import_tslib40.__classPrivateFieldGet)(this, _Album_page, "f").contents_memo)
      throw new Error("No contents found in the response");
    this.contents = (_c = (0, import_tslib40.__classPrivateFieldGet)(this, _Album_page, "f").contents_memo.getType(MusicShelf_default)) === null || _c === void 0 ? void 0 : _c.first().contents;
    this.sections = (0, import_tslib40.__classPrivateFieldGet)(this, _Album_page, "f").contents_memo.getType(MusicCarouselShelf_default) || [];
  }
  get page() {
    return (0, import_tslib40.__classPrivateFieldGet)(this, _Album_page, "f");
  }
};
__name(Album, "Album");
...
var Artist = class {
  constructor(response, actions) {
    ...
    (0, import_tslib41.__classPrivateFieldSet)(this, _Artist_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib41.__classPrivateFieldSet)(this, _Artist_actions, actions, "f");
    ...
    const music_shelf = ((_b2 = (0, import_tslib41.__classPrivateFieldGet)(this, _Artist_page, "f").contents_memo) === null || _b2 === void 0 ? void 0 : _b2.getType(MusicShelf_default)) || [];
    const music_carousel_shelf = ((_c = (0, import_tslib41.__classPrivateFieldGet)(this, _Artist_page, "f").contents_memo) === null || _c === void 0 ? void 0 : _c.getType(MusicCarouselShelf_default)) || [];
  ...
  getAllSongs() {
    ...
    return (0, import_tslib41.__awaiter)(this, void 0, void 0, function* () {
      ...
      const page = yield shelf.endpoint.call((0, import_tslib41.__classPrivateFieldGet)(this, _Artist_actions, "f"), { client: "YTMUSIC", parse: true });
  ...
  get page() {
    return (0, import_tslib41.__classPrivateFieldGet)(this, _Artist_page, "f");
  }
};
...
var Explore = class {
  constructor(response) {
    ...
    (0, import_tslib42.__classPrivateFieldSet)(this, _Explore_page, parser_default.parseResponse(response.data), "f");
    const tab = (_a4 = (0, import_tslib42.__classPrivateFieldGet)(this, _Explore_page, "f").contents) === null || _a4 === void 0 ? void 0 : _a4.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
  ...
  get page() {
    return (0, import_tslib42.__classPrivateFieldGet)(this, _Explore_page, "f");
  }
};
...
var HomeFeed2 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib43.__classPrivateFieldSet)(this, _HomeFeed_actions, actions, "f");
    (0, import_tslib43.__classPrivateFieldSet)(this, _HomeFeed_page, parser_default.parseResponse(response.data), "f");
    const tab = (_a4 = (0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_page, "f").contents) === null || _a4 === void 0 ? void 0 : _a4.item().as(SingleColumnBrowseResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find Home tab.");
    if (tab.content === null) {
      if (!(0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_page, "f").continuation_contents)
        throw new InnertubeError("Continuation did not have any content.");
      (0, import_tslib43.__classPrivateFieldSet)(this, _HomeFeed_continuation, (0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_page, "f").continuation_contents.as(SectionListContinuation).continuation, "f");
      this.sections = (_b2 = (0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_page, "f").continuation_contents.as(SectionListContinuation).contents) === null || _b2 === void 0 ? void 0 : _b2.as(MusicCarouselShelf_default);
      return;
    }
    ...
    (0, import_tslib43.__classPrivateFieldSet)(this, _HomeFeed_continuation, (_e = tab.content) === null || _e === void 0 ? void 0 : _e.as(SectionList_default).continuation, "f");
  ...
  getContinuation() {
    return (0, import_tslib43.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_continuation, "f")
      });
      return new HomeFeed2(response, (0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_actions, "f"));
    });
  }
  applyFilter(target_filter) {
    ...
    return (0, import_tslib43.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield cloud_chip.endpoint.call((0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_actions, "f"), { client: "YTMUSIC" });
      return new HomeFeed2(response, (0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_actions, "f"));
    });
  }
  get filters() {
  ...
  get has_continuation() {
    return !!(0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_continuation, "f");
  }
  get page() {
    return (0, import_tslib43.__classPrivateFieldGet)(this, _HomeFeed_page, "f");
  }
};
...
var Library2 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib44.__classPrivateFieldSet)(this, _Library_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib44.__classPrivateFieldSet)(this, _Library_actions, actions, "f");
    const section_list = (_a4 = (0, import_tslib44.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(SectionList_default).first();
    ...
    (0, import_tslib44.__classPrivateFieldSet)(this, _Library_continuation, (_e = (_d = this.contents) === null || _d === void 0 ? void 0 : _d.find((list) => list.continuation)) === null || _e === void 0 ? void 0 : _e.continuation, "f");
  }
  applySort(sort_by) {
    var _a4, _b2, _c, _d, _e, _f, _g, _h, _j, _k;
    return (0, import_tslib44.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (typeof sort_by === "string") {
        const button = (_a4 = (0, import_tslib44.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(MusicSortFilterButton_default).first();
      ...
      const response = yield (0, import_tslib44.__classPrivateFieldGet)(this, _Library_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: cmd.continuation.reloadContinuationData.continuation,
        parse: true
      });
      const previously_selected_item = (_h = (_g = (0, import_tslib44.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _g === void 0 ? void 0 : _g.getType(MusicMultiSelectMenuItem_default)) === null || _h === void 0 ? void 0 : _h.find((item) => item.selected);
  ...
  applyFilter(filter) {
    ...
    return (0, import_tslib44.__awaiter)(this, void 0, void 0, function* () {
      let target_chip;
      const chip_cloud = (_a4 = (0, import_tslib44.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(ChipCloud_default).first();
      if (typeof filter === "string") {
      ...
      const response = yield target_cmd.call((0, import_tslib44.__classPrivateFieldGet)(this, _Library_actions, "f"), { client: "YTMUSIC" });
      return new Library2(response, (0, import_tslib44.__classPrivateFieldGet)(this, _Library_actions, "f"));
    });
  }
  getContinuation() {
    return (0, import_tslib44.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib44.__classPrivateFieldGet)(this, _Library_continuation, "f"))
        throw new InnertubeError("No continuation available");
      const page = yield (0, import_tslib44.__classPrivateFieldGet)(this, _Library_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib44.__classPrivateFieldGet)(this, _Library_continuation, "f")
      });
      return new LibraryContinuation(page, (0, import_tslib44.__classPrivateFieldGet)(this, _Library_actions, "f"));
    });
  }
  get has_continuation() {
    return !!(0, import_tslib44.__classPrivateFieldGet)(this, _Library_continuation, "f");
  }
  get sort_options() {
    var _a4, _b2;
    const button = (_a4 = (0, import_tslib44.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(MusicSortFilterButton_default).first();
  ...
  get filters() {
    var _a4, _b2;
    return ((_b2 = (_a4 = (0, import_tslib44.__classPrivateFieldGet)(this, _Library_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(ChipCloud_default)) === null || _b2 === void 0 ? void 0 : _b2.first().chips.map((chip) => chip.text)) || [];
  }
  get page() {
    return (0, import_tslib44.__classPrivateFieldGet)(this, _Library_page, "f");
  }
};
...
var LibraryContinuation = class {
  constructor(response, actions) {
    ...
    (0, import_tslib44.__classPrivateFieldSet)(this, _LibraryContinuation_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib44.__classPrivateFieldSet)(this, _LibraryContinuation_actions, actions, "f");
    if (!(0, import_tslib44.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f").continuation_contents)
      throw new InnertubeError("No continuation contents found");
    this.contents = (0, import_tslib44.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f").continuation_contents.as(MusicShelfContinuation, GridContinuation);
    (0, import_tslib44.__classPrivateFieldSet)(this, _LibraryContinuation_continuation, this.contents.continuation || null, "f");
  }
  getContinuation() {
    return (0, import_tslib44.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib44.__classPrivateFieldGet)(this, _LibraryContinuation_continuation, "f"))
        throw new InnertubeError("No continuation available");
      const response = yield (0, import_tslib44.__classPrivateFieldGet)(this, _LibraryContinuation_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib44.__classPrivateFieldGet)(this, _LibraryContinuation_continuation, "f")
      });
      return new LibraryContinuation(response, (0, import_tslib44.__classPrivateFieldGet)(this, _LibraryContinuation_actions, "f"));
    });
  }
  get has_continuation() {
    return !!(0, import_tslib44.__classPrivateFieldGet)(this, _LibraryContinuation_continuation, "f");
  }
  get page() {
    return (0, import_tslib44.__classPrivateFieldGet)(this, _LibraryContinuation_page, "f");
  }
};
...
var Playlist3 = class {
  constructor(response, actions) {
    ...
    (0, import_tslib45.__classPrivateFieldSet)(this, _Playlist_actions, actions, "f");
    (0, import_tslib45.__classPrivateFieldSet)(this, _Playlist_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib45.__classPrivateFieldSet)(this, _Playlist_last_fetched_suggestions, null, "f");
    (0, import_tslib45.__classPrivateFieldSet)(this, _Playlist_suggestions_continuation, null, "f");
    if ((0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f").continuation_contents) {
      const data = (_a4 = (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f").continuation_contents) === null || _a4 === void 0 ? void 0 : _a4.as(MusicPlaylistShelfContinuation);
      this.items = data.contents;
      (0, import_tslib45.__classPrivateFieldSet)(this, _Playlist_continuation, data.continuation, "f");
    } else {
      if (((_b2 = (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f").header) === null || _b2 === void 0 ? void 0 : _b2.item().type) === "MusicEditablePlaylistDetailHeader") {
        this.header = (_d = (_c = (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f").header) === null || _c === void 0 ? void 0 : _c.item().as(MusicEditablePlaylistDetailHeader_default).header) === null || _d === void 0 ? void 0 : _d.as(MusicDetailHeader_default);
      } else {
        this.header = (_e = (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f").header) === null || _e === void 0 ? void 0 : _e.item().as(MusicDetailHeader_default);
      }
      this.items = ((_f = (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _f === void 0 ? void 0 : _f.getType(MusicPlaylistShelf_default).first().contents) || null;
      (0, import_tslib45.__classPrivateFieldSet)(this, _Playlist_continuation, ((_g = (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _g === void 0 ? void 0 : _g.getType(MusicPlaylistShelf_default).first().continuation) || null, "f");
    }
  }
  getContinuation() {
    return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation: (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_continuation, "f")
      });
      return new Playlist3(response, (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_actions, "f"));
    });
  }
  getRelated() {
    var _a4, _b2, _c, _d, _e;
    return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
      let section_continuation = (_b2 = (_a4 = (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(SectionList_default)) === null || _b2 === void 0 ? void 0 : _b2[0].continuation;
      while (section_continuation) {
        const data = yield (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_actions, "f").execute("/browse", {
          client: "YTMUSIC",
  ...
  getSuggestions(refresh = true) {
    return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
      const require_fetch = refresh || !(0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_last_fetched_suggestions, "f");
      const fetch_promise = require_fetch ? (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_instances2, "m", _Playlist_fetchSuggestions).call(this) : Promise.resolve(null);
      const fetch_result = yield fetch_promise;
      if (fetch_result) {
        (0, import_tslib45.__classPrivateFieldSet)(this, _Playlist_last_fetched_suggestions, fetch_result.items, "f");
        (0, import_tslib45.__classPrivateFieldSet)(this, _Playlist_suggestions_continuation, fetch_result.continuation, "f");
      }
      return (fetch_result === null || fetch_result === void 0 ? void 0 : fetch_result.items) || (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_last_fetched_suggestions, "f");
    });
  }
  get page() {
    return (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f");
  }
  get has_continuation() {
    return !!(0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_continuation, "f");
  }
};
...
_Playlist_page = /* @__PURE__ */ new WeakMap(), _Playlist_actions = /* @__PURE__ */ new WeakMap(), _Playlist_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_last_fetched_suggestions = /* @__PURE__ */ new WeakMap(), _Playlist_suggestions_continuation = /* @__PURE__ */ new WeakMap(), _Playlist_instances2 = /* @__PURE__ */ new WeakSet(), _Playlist_fetchSuggestions = /* @__PURE__ */ __name(function _Playlist_fetchSuggestions2() {
  var _a4, _b2, _c, _d, _e;
  return (0, import_tslib45.__awaiter)(this, void 0, void 0, function* () {
    const continuation = (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_suggestions_continuation, "f") || ((_b2 = (_a4 = (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.get("SectionList")) === null || _b2 === void 0 ? void 0 : _b2[0].as(SectionList_default).continuation);
    if (continuation) {
      const page = yield (0, import_tslib45.__classPrivateFieldGet)(this, _Playlist_actions, "f").execute("/browse", {
        client: "YTMUSIC",
        continuation,
        parse: true
      });
...
var Recap = class {
  constructor(response, actions) {
    ...
    (0, import_tslib46.__classPrivateFieldSet)(this, _Recap_page, parser_default.parseResponse(response.data), "f");
    (0, import_tslib46.__classPrivateFieldSet)(this, _Recap_actions, actions, "f");
    const header = (_a4 = (0, import_tslib46.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _a4 === void 0 ? void 0 : _a4.item();
    this.header = (header === null || header === void 0 ? void 0 : header.is(MusicElementHeader_default)) ? (_d = (_c = (_b2 = (0, import_tslib46.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _b2 === void 0 ? void 0 : _b2.item().as(MusicElementHeader_default).element) === null || _c === void 0 ? void 0 : _c.model) === null || _d === void 0 ? void 0 : _d.as(HighlightsCarousel_default) : (_e = (0, import_tslib46.__classPrivateFieldGet)(this, _Recap_page, "f").header) === null || _e === void 0 ? void 0 : _e.item().as(MusicHeader_default);
    const tab = (_f = (0, import_tslib46.__classPrivateFieldGet)(this, _Recap_page, "f").contents) === null || _f === void 0 ? void 0 : _f.item().as(SingleColumnBrowseResults_default).tabs.firstOfType(Tab_default);
    if (!tab)
      throw new InnertubeError("Target tab not found");
  ...
  getPlaylist() {
    return (0, import_tslib46.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield endpoint.call((0, import_tslib46.__classPrivateFieldGet)(this, _Recap_actions, "f"), { client: "YTMUSIC" });
      return new Playlist_default3(response, (0, import_tslib46.__classPrivateFieldGet)(this, _Recap_actions, "f"));
    });
  }
  get page() {
    return (0, import_tslib46.__classPrivateFieldGet)(this, _Recap_page, "f");
  }
};
__name(Recap, "Recap");
...
var Search2 = class {
  constructor(response, actions, is_filtered) {
    ...
    (0, import_tslib47.__classPrivateFieldSet)(this, _Search_actions, actions, "f");
    (0, import_tslib47.__classPrivateFieldSet)(this, _Search_page, parser_default.parseResponse(response.data), "f");
    if (!(0, import_tslib47.__classPrivateFieldGet)(this, _Search_page, "f").contents || !(0, import_tslib47.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo)
      throw new InnertubeError("Response did not contain any contents.");
    const tab = (0, import_tslib47.__classPrivateFieldGet)(this, _Search_page, "f").contents.item().as(TabbedSearchResults_default).tabs.get({ selected: true });
    if (!tab)
      throw new InnertubeError("Could not find target tab.");
    ...
    if (is_filtered) {
      (0, import_tslib47.__classPrivateFieldSet)(this, _Search_continuation, (_c = this.contents.firstOfType(MusicShelf_default)) === null || _c === void 0 ? void 0 : _c.continuation, "f");
    }
  }
  getMore(shelf) {
    return (0, import_tslib47.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield shelf.endpoint.call((0, import_tslib47.__classPrivateFieldGet)(this, _Search_actions, "f"), { client: "YTMUSIC" });
      if (!response)
        throw new InnertubeError("Endpoint did not return any data");
      return new Search2(response, (0, import_tslib47.__classPrivateFieldGet)(this, _Search_actions, "f"), true);
    });
  }
  getContinuation() {
    return (0, import_tslib47.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib47.__classPrivateFieldGet)(this, _Search_continuation, "f"))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib47.__classPrivateFieldGet)(this, _Search_actions, "f").execute("/search", {
        continuation: (0, import_tslib47.__classPrivateFieldGet)(this, _Search_continuation, "f"),
        client: "YTMUSIC"
      });
      return new SearchContinuation((0, import_tslib47.__classPrivateFieldGet)(this, _Search_actions, "f"), response);
    });
  }
  applyFilter(target_filter) {
    var _a4, _b2;
    return (0, import_tslib47.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!cloud_chip.endpoint)
        throw new InnertubeError("Selected filter does not have an endpoint.");
      const response = yield cloud_chip.endpoint.call((0, import_tslib47.__classPrivateFieldGet)(this, _Search_actions, "f"), { client: "YTMUSIC" });
      return new Search2(response, (0, import_tslib47.__classPrivateFieldGet)(this, _Search_actions, "f"), true);
    });
  }
  get filters() {
  ...
  get has_continuation() {
    return !!(0, import_tslib47.__classPrivateFieldGet)(this, _Search_continuation, "f");
  }
  get did_you_mean() {
    var _a4;
    return (_a4 = (0, import_tslib47.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(DidYouMean_default).first();
  }
  get showing_results_for() {
    var _a4;
    return (_a4 = (0, import_tslib47.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(ShowingResultsFor_default).first();
  }
  get message() {
    var _a4;
    return (_a4 = (0, import_tslib47.__classPrivateFieldGet)(this, _Search_page, "f").contents_memo) === null || _a4 === void 0 ? void 0 : _a4.getType(Message_default).first();
  }
  get songs() {
    var _a4;
  ...
  get page() {
    return (0, import_tslib47.__classPrivateFieldGet)(this, _Search_page, "f");
  }
};
...
var SearchContinuation = class {
  constructor(actions, response) {
    ...
    (0, import_tslib47.__classPrivateFieldSet)(this, _SearchContinuation_actions, actions, "f");
    (0, import_tslib47.__classPrivateFieldSet)(this, _SearchContinuation_page, parser_default.parseResponse(response.data), "f");
    this.header = (_a4 = (0, import_tslib47.__classPrivateFieldGet)(this, _SearchContinuation_page, "f").header) === null || _a4 === void 0 ? void 0 : _a4.item().as(MusicHeader_default);
    this.contents = (_b2 = (0, import_tslib47.__classPrivateFieldGet)(this, _SearchContinuation_page, "f").continuation_contents) === null || _b2 === void 0 ? void 0 : _b2.as(MusicShelfContinuation);
  }
  getContinuation() {
    var _a4;
    return (0, import_tslib47.__awaiter)(this, void 0, void 0, function* () {
      if (!((_a4 = this.contents) === null || _a4 === void 0 ? void 0 : _a4.continuation))
        throw new InnertubeError("Continuation not found.");
      const response = yield (0, import_tslib47.__classPrivateFieldGet)(this, _SearchContinuation_actions, "f").execute("/search", {
        continuation: this.contents.continuation,
        client: "YTMUSIC"
      });
      return new SearchContinuation((0, import_tslib47.__classPrivateFieldGet)(this, _SearchContinuation_actions, "f"), response);
    });
  }
  get has_continuation() {
    var _a4;
  ...
  get page() {
    return (0, import_tslib47.__classPrivateFieldGet)(this, _SearchContinuation_page, "f");
  }
};
...
var Author = class {
  constructor(item, badges, thumbs, id) {
    ...
    (0, import_tslib52.__classPrivateFieldSet)(this, _Author_nav_text, new Text(item), "f");
    this.id = id || ((_e = (_d = (_c = (_b2 = (_a4 = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _a4 === void 0 ? void 0 : _a4.runs) === null || _b2 === void 0 ? void 0 : _b2[0]) === null || _c === void 0 ? void 0 : _c.endpoint) === null || _d === void 0 ? void 0 : _d.payload) === null || _e === void 0 ? void 0 : _e.browseId) || ((_h = (_g = (_f = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _f === void 0 ? void 0 : _f.endpoint) === null || _g === void 0 ? void 0 : _g.payload) === null || _h === void 0 ? void 0 : _h.browseId) || "N/A";
    this.name = ((_j = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _j === void 0 ? void 0 : _j.text) || "N/A";
    this.thumbnails = thumbs ? Thumbnail.fromResponse(thumbs) : [];
    this.endpoint = ((_m = (_l = (_k = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _k === void 0 ? void 0 : _k.runs) === null || _l === void 0 ? void 0 : _l[0]) === null || _m === void 0 ? void 0 : _m.endpoint) || ((_o = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _o === void 0 ? void 0 : _o.endpoint);
    ...
    this.url = ((_w = (_v = (_u = (_t = (_s = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _s === void 0 ? void 0 : _s.runs) === null || _t === void 0 ? void 0 : _t[0]) === null || _u === void 0 ? void 0 : _u.endpoint) === null || _v === void 0 ? void 0 : _v.metadata) === null || _w === void 0 ? void 0 : _w.api_url) === "/browse" && `${URLS.YT_BASE}${((_1 = (_0 = (_z = (_y = (_x = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _x === void 0 ? void 0 : _x.runs) === null || _y === void 0 ? void 0 : _y[0]) === null || _z === void 0 ? void 0 : _z.endpoint) === null || _0 === void 0 ? void 0 : _0.payload) === null || _1 === void 0 ? void 0 : _1.canonicalBaseUrl) || `/u/${(_6 = (_5 = (_4 = (_3 = (_2 = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _2 === void 0 ? void 0 : _2.runs) === null || _3 === void 0 ? void 0 : _3[0]) === null || _4 === void 0 ? void 0 : _4.endpoint) === null || _5 === void 0 ? void 0 : _5.payload) === null || _6 === void 0 ? void 0 : _6.browseId}`}` || `${URLS.YT_BASE}${((_9 = (_8 = (_7 = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _7 === void 0 ? void 0 : _7.endpoint) === null || _8 === void 0 ? void 0 : _8.payload) === null || _9 === void 0 ? void 0 : _9.canonicalBaseUrl) || `/u/${(_12 = (_11 = (_10 = (0, import_tslib52.__classPrivateFieldGet)(this, _Author_nav_text, "f")) === null || _10 === void 0 ? void 0 : _10.endpoint) === null || _11 === void 0 ? void 0 : _11.payload) === null || _12 === void 0 ? void 0 : _12.browseId}`}`;
  }
  get best_thumbnail() {
    return this.thumbnails[0];
  }
...
var Platform = class {
  static load(platform) {
    (0, import_tslib53.__classPrivateFieldSet)(Platform, _a, platform, "f", _Platform_shim);
  }
  static get shim() {
    if (!(0, import_tslib53.__classPrivateFieldGet)(Platform, _a, "f", _Platform_shim)) {
      throw new Error("Platform is not loaded");
    }
    return (0, import_tslib53.__classPrivateFieldGet)(Platform, _a, "f", _Platform_shim);
  }
};
...
function streamToIterable(stream) {
  return (0, import_tslib53.__asyncGenerator)(this, arguments, /* @__PURE__ */ __name(function* streamToIterable_1() {
    const reader = stream.getReader();
    try {
      while (true) {
        const { done, value } = yield (0, import_tslib53.__await)(reader.read());
        if (done) {
          return yield (0, import_tslib53.__await)(void 0);
        }
        yield yield (0, import_tslib53.__await)(value);
      }
    } finally {
      reader.releaseLock();
    }
...
var CustomEvent = class extends Event {
  constructor(type, options) {
    ...
    (0, import_tslib54.__classPrivateFieldSet)(this, _CustomEvent_detail, (_a4 = options === null || options === void 0 ? void 0 : options.detail) !== null && _a4 !== void 0 ? _a4 : null, "f");
  }
  get detail() {
    return (0, import_tslib54.__classPrivateFieldGet)(this, _CustomEvent_detail, "f");
  }
};
...
var Actions = class {
  constructor(session) {
    ...
    (0, import_tslib55.__classPrivateFieldSet)(this, _Actions_session, session, "f");
  }
  get session() {
    return (0, import_tslib55.__classPrivateFieldGet)(this, _Actions_session, "f");
  }
  stats(url, client, params) {
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib55.__classPrivateFieldGet)(this, _Actions_session, "f").http.fetch(s_url);
      return response;
    });
  }
    ...
    return (0, import_tslib55.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (args && !args.protobuf) {
        ...
        if (Reflect.has(data, "browseId")) {
          if ((0, import_tslib55.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_needsLogin).call(this, data.browseId) && !(0, import_tslib55.__classPrivateFieldGet)(this, _Actions_session, "f").logged_in)
      ...
      const response = yield (0, import_tslib55.__classPrivateFieldGet)(this, _Actions_session, "f").http.fetch(target_endpoint, {
        method: "POST",
      ...
      if (args === null || args === void 0 ? void 0 : args.parse) {
        ...
        if ((0, import_tslib55.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_isBrowse).call(this, parsed_response) && ((_b2 = (_a4 = parsed_response.on_response_received_actions) === null || _a4 === void 0 ? void 0 : _a4.first()) === null || _b2 === void 0 ? void 0 : _b2.type) === "navigateAction") {
      ...
      return (0, import_tslib55.__classPrivateFieldGet)(this, _Actions_instances, "m", _Actions_wrap).call(this, response);
    });
  }
};
...
var Player = class {
  constructor(signature_timestamp, sig_sc, nsig_sc, player_id) {
    ...
    (0, import_tslib56.__classPrivateFieldSet)(this, _Player_nsig_sc, nsig_sc, "f");
    (0, import_tslib56.__classPrivateFieldSet)(this, _Player_sig_sc, sig_sc, "f");
    (0, import_tslib56.__classPrivateFieldSet)(this, _Player_sig_sc_timestamp, signature_timestamp, "f");
    (0, import_tslib56.__classPrivateFieldSet)(this, _Player_player_id, player_id, "f");
    (0, import_tslib56.__classPrivateFieldSet)(this, _Player_nsig_cache, /* @__PURE__ */ new Map(), "f");
  }
  ...
  decipher(url, signature_cipher, cipher, this_response_nsig_cache) {
    ...
    if (signature_cipher || cipher) {
      const signature = Platform.shim.eval((0, import_tslib56.__classPrivateFieldGet)(this, _Player_sig_sc, "f"), {
        sig: args.get("s")
      });
    ...
    if (n) {
      ...
      if (this_response_nsig_cache && this_response_nsig_cache.has(n)) {
        ...
        nsig = Platform.shim.eval((0, import_tslib56.__classPrivateFieldGet)(this, _Player_nsig_sc, "f"), {
          nsig: n
        });
  ...
  cache(cache) {
    return (0, import_tslib56.__awaiter)(this, void 0, void 0, function* () {
      ...
      const sig_buf = encoder.encode((0, import_tslib56.__classPrivateFieldGet)(this, _Player_sig_sc, "f"));
      const nsig_buf = encoder.encode((0, import_tslib56.__classPrivateFieldGet)(this, _Player_nsig_sc, "f"));
      const buffer = new ArrayBuffer(12 + sig_buf.byteLength + nsig_buf.byteLength);
      const view = new DataView(buffer);
      view.setUint32(0, Player.LIBRARY_VERSION, true);
      view.setUint32(4, (0, import_tslib56.__classPrivateFieldGet)(this, _Player_sig_sc_timestamp, "f"), true);
      ...
      yield cache.set((0, import_tslib56.__classPrivateFieldGet)(this, _Player_player_id, "f"), new Uint8Array(buffer));
    });
  }
  ...
  get url() {
    return new URL(`/s/player/${(0, import_tslib56.__classPrivateFieldGet)(this, _Player_player_id, "f")}/player_ias.vflset/en_US/base.js`, URLS.YT_BASE).toString();
  }
  get sts() {
    return (0, import_tslib56.__classPrivateFieldGet)(this, _Player_sig_sc_timestamp, "f");
  }
  get nsig_sc() {
    return (0, import_tslib56.__classPrivateFieldGet)(this, _Player_nsig_sc, "f");
  }
  get sig_sc() {
    return (0, import_tslib56.__classPrivateFieldGet)(this, _Player_sig_sc, "f");
  }
...
var OAuth = class {
  ...
  revokeCredentials() {
    return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
      ...
      return (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL(`/o/oauth2/revoke?token=${encodeURIComponent((0, import_tslib57.__classPrivateFieldGet)(this, _OAuth_credentials, "f").access_token)}`, URLS.YT_BASE), {
        method: "post"
      });
    });
  }
...
_OAuth_identity = /* @__PURE__ */ new WeakMap(), _OAuth_session = /* @__PURE__ */ new WeakMap(), _OAuth_credentials = /* @__PURE__ */ new WeakMap(), _OAuth_polling_interval = /* @__PURE__ */ new WeakMap(), _OAuth_instances = /* @__PURE__ */ new WeakSet(), _OAuth_loadCachedCredentials = /* @__PURE__ */ __name(function _OAuth_loadCachedCredentials2() {
  ...
  return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
    ...
    const response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/device/code", URLS.YT_BASE), {
  ...
  const poller = setInterval(() => (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
    const data = Object.assign(Object.assign({}, (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth_identity, "f")), { code: device_code, grant_type: OAUTH.GRANT_TYPE });
    try {
      const response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/o/oauth2/token", URLS.YT_BASE), {
        body: JSON.stringify(data),
        method: "POST",
        headers: {
          "Content-Type": "application/json"
  ...
  var _a4;
  return (0, import_tslib57.__awaiter)(this, void 0, void 0, function* () {
    const response = yield (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch_function(new URL("/tv", URLS.YT_BASE), { headers: OAUTH.HEADERS });
    ...
    const script = yield (0, import_tslib57.__classPrivateFieldGet)(this, _OAuth_session, "f").http.fetch(url_body, { baseURL: URLS.YT_BASE });
...
var Session = class extends EventEmitterLike_default {
  constructor(context, api_key, api_version, account_index, player, cookie, fetch, cache) {
    ...
    (0, import_tslib58.__classPrivateFieldSet)(this, _Session_context, context, "f");
    (0, import_tslib58.__classPrivateFieldSet)(this, _Session_account_index, account_index, "f");
    (0, import_tslib58.__classPrivateFieldSet)(this, _Session_key, api_key, "f");
    (0, import_tslib58.__classPrivateFieldSet)(this, _Session_api_version, api_version, "f");
    (0, import_tslib58.__classPrivateFieldSet)(this, _Session_player, player, "f");
  ...
  static getSessionData(lang = "", location = "", account_index = 0, visitor_data = "", enable_safety_mode = false, generate_session_locally = false, device_category = "desktop", client_name = ClientType.WEB, tz = Intl.DateTimeFormat().resolvedOptions().timeZone, fetch = Platform.shim.fetch, on_behalf_of_user) {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (generate_session_locally) {
        session_data = (0, import_tslib58.__classPrivateFieldGet)(this, _a2, "m", _Session_generateSessionData).call(this, session_args);
      } else {
        try {
          session_data = yield (0, import_tslib58.__classPrivateFieldGet)(this, _a2, "m", _Session_retrieveSessionData).call(this, session_args, fetch);
        } catch (err) {
          session_data = (0, import_tslib58.__classPrivateFieldGet)(this, _a2, "m", _Session_generateSessionData).call(this, session_args);
        }
      }
  ...
  signIn(credentials) {
    return (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
      return new Promise((resolve, reject) => (0, import_tslib58.__awaiter)(this, void 0, void 0, function* () {
  ...
  get key() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Session_key, "f");
  }
  get api_version() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Session_api_version, "f");
  }
  get client_version() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Session_context, "f").client.clientVersion;
  }
  get client_name() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Session_context, "f").client.clientName;
  }
  get account_index() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Session_account_index, "f");
  }
  get context() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Session_context, "f");
  }
  get player() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Session_player, "f");
  }
  get lang() {
    return (0, import_tslib58.__classPrivateFieldGet)(this, _Session_context, "f").client.hl;
  }
};
...
var Kids = class {
  constructor(session) {
    ...
    (0, import_tslib59.__classPrivateFieldSet)(this, _Kids_session, session, "f");
  }
  search(query) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib59.__classPrivateFieldGet)(this, _Kids_session, "f").actions.execute(SearchEndpoint_exports.PATH, SearchEndpoint_exports.build({ client: "YTKIDS", query }));
      return new Search_default3((0, import_tslib59.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
  getInfo(video_id) {
    var _a4;
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      const player_payload = PlayerEndpoint_exports.build({
        sts: (_a4 = (0, import_tslib59.__classPrivateFieldGet)(this, _Kids_session, "f").player) === null || _a4 === void 0 ? void 0 : _a4.sts,
        client: "YTKIDS",
        video_id
      });
      ...
      const player_response = (0, import_tslib59.__classPrivateFieldGet)(this, _Kids_session, "f").actions.execute(PlayerEndpoint_exports.PATH, player_payload);
      const next_response = (0, import_tslib59.__classPrivateFieldGet)(this, _Kids_session, "f").actions.execute(NextEndpoint_exports.PATH, next_payload);
      const response = yield Promise.all([player_response, next_response]);
      const cpn = generateRandomString(16);
      return new VideoInfo_default2(response, (0, import_tslib59.__classPrivateFieldGet)(this, _Kids_session, "f").actions, cpn);
    });
  }
  getChannel(channel_id) {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib59.__classPrivateFieldGet)(this, _Kids_session, "f").actions.execute(BrowseEndpoint_exports.PATH, BrowseEndpoint_exports.build({
        browse_id: channel_id,
        client: "YTKIDS"
      }));
      return new Channel_default2((0, import_tslib59.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
  getHomeFeed() {
    return (0, import_tslib59.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new HomeFeed_default2((0, import_tslib59.__classPrivateFieldGet)(this, _Kids_session, "f").actions, response);
    });
  }
};
__name(Kids, "Kids");
...
var Music = class {
  constructor(session) {
    ...
    (0, import_tslib60.__classPrivateFieldSet)(this, _Music_session, session, "f");
    (0, import_tslib60.__classPrivateFieldSet)(this, _Music_actions, session.actions, "f");
  }
  getInfo(target) {
    if (target instanceof MusicTwoRowItem_default) {
      return (0, import_tslib60.__classPrivateFieldGet)(this, _Music_instances, "m", _Music_fetchInfoFromListItem).call(this, target);
    } else if (typeof target === "string") {
      return (0, import_tslib60.__classPrivateFieldGet)(this, _Music_instances, "m", _Music_fetchInfoFromVideoId).call(this, target);
    }
  ...
  search(query, filters = {}) {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f").execute(SearchEndpoint_exports.PATH, SearchEndpoint_exports.build({
        query,
        client: "YTMUSIC",
        params: filters.type && filters.type !== "all" ? encodeMusicSearchFilters(filters) : void 0
      }));
      return new Search_default2(response, (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"), Reflect.has(filters, "type") && filters.type !== "all");
    });
  }
  getHomeFeed() {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f").execute(BrowseEndpoint_exports.PATH, BrowseEndpoint_exports.build({
        browse_id: "FEmusic_home",
        client: "YTMUSIC"
      }));
      return new HomeFeed_default(response, (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getExplore() {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
  ...
  getLibrary() {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Library_default2(response, (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getArtist(artist_id) {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Artist_default(response, (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getAlbum(album_id) {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
  ...
  getPlaylist(playlist_id) {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Playlist_default3(response, (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getUpNext(video_id, automix = true) {
    ...
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f").execute(NextEndpoint_exports.PATH, Object.assign(Object.assign({}, NextEndpoint_exports.build({ video_id, client: "YTMUSIC" })), { parse: true }));
      ...
      if (!playlist_panel.playlist_id && automix) {
        ...
        if (!automix_preview_video)
          throw new InnertubeError("Automix item not found");
        const page = yield (_c = automix_preview_video.playlist_video) === null || _c === void 0 ? void 0 : _c.endpoint.call((0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"), {
          videoId: video_id,
          client: "YTMUSIC",
          parse: true
        });
  ...
  getRelated(video_id) {
    ...
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!tab)
        throw new InnertubeError("Could not find target tab.");
      const page = yield tab.endpoint.call((0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"), { client: "YTMUSIC", parse: true });
      if (!page.contents)
  ...
  getRecap() {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Recap_default(response, (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"));
    });
  }
  getSearchSuggestions(query) {
    return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f").execute(GetSearchSuggestionsEndpoint_exports.PATH, Object.assign(Object.assign({}, GetSearchSuggestionsEndpoint_exports.build({ input: query })), { parse: true }));
...
_Music_session = /* @__PURE__ */ new WeakMap(), _Music_actions = /* @__PURE__ */ new WeakMap(), _Music_instances = /* @__PURE__ */ new WeakSet(), _Music_fetchInfoFromVideoId = /* @__PURE__ */ __name(function _Music_fetchInfoFromVideoId2(video_id) {
  ...
  return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
    const player_payload = PlayerEndpoint_exports.build({
      video_id,
      sts: (_a4 = (0, import_tslib60.__classPrivateFieldGet)(this, _Music_session, "f").player) === null || _a4 === void 0 ? void 0 : _a4.sts,
      client: "YTMUSIC"
    });
    const next_payload = NextEndpoint_exports.build({
      video_id,
    ...
    const player_response = (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f").execute(PlayerEndpoint_exports.PATH, player_payload);
    const next_response = (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f").execute(NextEndpoint_exports.PATH, next_payload);
    const response = yield Promise.all([player_response, next_response]);
    const cpn = generateRandomString(16);
    return new TrackInfo_default(response, (0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"), cpn);
  });
  ...
  return (0, import_tslib60.__awaiter)(this, void 0, void 0, function* () {
    ...
    const player_response = list_item.endpoint.call((0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"), {
      client: "YTMUSIC",
      playbackContext: {
        contentPlaybackContext: Object.assign({
          signatureTimestamp: (_a4 = (0, import_tslib60.__classPrivateFieldGet)(this, _Music_session, "f").player) === null || _a4 === void 0 ? void 0 : _a4.sts
        })
      }
    });
    const next_response = list_item.endpoint.call((0, import_tslib60.__classPrivateFieldGet)(this, _Music_actions, "f"), {
      client: "YTMUSIC",
...
var Studio = class {
  constructor(session) {
    ...
    (0, import_tslib61.__classPrivateFieldSet)(this, _Studio_session, session, "f");
  }
  setThumbnail(video_id, buffer) {
    return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib61.__classPrivateFieldGet)(this, _Studio_session, "f").logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      if (!video_id || !buffer)
        throw new MissingParamError("One or more parameters are missing.");
      const payload = encodeCustomThumbnailPayload(video_id, buffer);
      const response = yield (0, import_tslib61.__classPrivateFieldGet)(this, _Studio_session, "f").actions.execute("/video_manager/metadata_update", {
        protobuf: true,
  ...
  upload(file, metadata = {}) {
    return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib61.__classPrivateFieldGet)(this, _Studio_session, "f").logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const initial_data = yield (0, import_tslib61.__classPrivateFieldGet)(this, _Studio_instances, "m", _Studio_getInitialUploadData).call(this);
      const upload_result = yield (0, import_tslib61.__classPrivateFieldGet)(this, _Studio_instances, "m", _Studio_uploadVideo).call(this, initial_data.upload_url, file);
      if (upload_result.status !== "STATUS_SUCCESS")
        throw new InnertubeError("Could not process video.");
      const response = yield (0, import_tslib61.__classPrivateFieldGet)(this, _Studio_instances, "m", _Studio_setVideoMetadata).call(this, initial_data, upload_result, metadata);
      return response;
    });
  }
};
...
_Studio_session = /* @__PURE__ */ new WeakMap(), _Studio_instances = /* @__PURE__ */ new WeakSet(), _Studio_getInitialUploadData = /* @__PURE__ */ __name(function _Studio_getInitialUploadData2() {
  return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
    ...
    const response = yield (0, import_tslib61.__classPrivateFieldGet)(this, _Studio_session, "f").http.fetch("/upload/youtubei", {
  ...
  return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
    const response = yield (0, import_tslib61.__classPrivateFieldGet)(this, _Studio_session, "f").http.fetch_function(upload_url, {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
  ...
  return (0, import_tslib61.__awaiter)(this, void 0, void 0, function* () {
    const response = yield (0, import_tslib61.__classPrivateFieldGet)(this, _Studio_session, "f").actions.execute(CreateVideoEndpoint_exports.PATH, CreateVideoEndpoint_exports.build({
      resource_id: {
        scotty_resource_id: {
...
var AccountManager = class {
  constructor(actions) {
    ...
    (0, import_tslib62.__classPrivateFieldSet)(this, _AccountManager_actions, actions, "f");
    this.channel = {
      editName: (new_name) => {
        if (!(0, import_tslib62.__classPrivateFieldGet)(this, _AccountManager_actions, "f").session.logged_in)
          throw new InnertubeError("You must be signed in to perform this operation.");
        return (0, import_tslib62.__classPrivateFieldGet)(this, _AccountManager_actions, "f").execute(channel_exports.EditNameEndpoint.PATH, channel_exports.EditNameEndpoint.build({
          given_name: new_name
        }));
      },
      editDescription: (new_description) => {
        if (!(0, import_tslib62.__classPrivateFieldGet)(this, _AccountManager_actions, "f").session.logged_in)
          throw new InnertubeError("You must be signed in to perform this operation.");
        return (0, import_tslib62.__classPrivateFieldGet)(this, _AccountManager_actions, "f").execute(channel_exports.EditDescriptionEndpoint.PATH, channel_exports.EditDescriptionEndpoint.build({
  ...
  getInfo() {
    return (0, import_tslib62.__awaiter)(this, void 0, void 0, function* () {
      if (!(0, import_tslib62.__classPrivateFieldGet)(this, _AccountManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield (0, import_tslib62.__classPrivateFieldGet)(this, _AccountManager_actions, "f").execute(account_exports.AccountListEndpoint.PATH, account_exports.AccountListEndpoint.build());
      return new AccountInfo_default(response);
    });
  }
  getTimeWatched() {
    return (0, import_tslib62.__awaiter)(this, void 0, void 0, function* () {
      const response = yield (0, import_tslib62.__classPrivateFieldGet)(this, _AccountManager_actions, "f").execute(BrowseEndpoint_exports.PATH, BrowseEndpoint_exports.build({
  ...
  getSettings() {
    return (0, import_tslib62.__awaiter)(this, void 0, void 0, function* () {
      ...
      return new Settings_default((0, import_tslib62.__classPrivateFieldGet)(this, _AccountManager_actions, "f"), response);
    });
  }
  getAnalytics() {
    var _a4;
...
var PlaylistManager = class {
  constructor(actions) {
    ...
    (0, import_tslib63.__classPrivateFieldSet)(this, _PlaylistManager_actions, actions, "f");
  }
  create(title, video_ids) {
    return (0, import_tslib63.__awaiter)(this, void 0, void 0, function* () {
      throwIfMissing({ title, video_ids });
      if (!(0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield (0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(CreateEndpoint_exports.PATH, CreateEndpoint_exports.build({
        ids: video_ids,
        title
      }));
      return {
  ...
  delete(playlist_id) {
    return (0, import_tslib63.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield (0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(DeleteEndpoint_exports.PATH, DeleteEndpoint_exports.build({
        playlist_id
      }));
      return {
        playlist_id,
  ...
  addVideos(playlist_id, video_ids) {
    return (0, import_tslib63.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const response = yield (0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(EditPlaylistEndpoint_exports.PATH, EditPlaylistEndpoint_exports.build({
  ...
  removeVideos(playlist_id, video_ids) {
    return (0, import_tslib63.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").session.logged_in)
        throw new InnertubeError("You must be signed in to perform this operation.");
      const info = yield (0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(BrowseEndpoint_exports.PATH, Object.assign(Object.assign({}, BrowseEndpoint_exports.build({ browse_id: `VL${playlist_id}` })), { parse: true }));
      const playlist = new Playlist_default2((0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f"), info, true);
      if (!playlist.info.is_editable)
        throw new InnertubeError("This playlist cannot be edited.", playlist_id);
      const payload = { playlist_id, actions: [] };
      const getSetVideoIds = /* @__PURE__ */ __name((pl) => (0, import_tslib63.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib63.__classPrivateFieldGet)(this, _PlaylistManager_actions, "f").execute(EditPlaylistEndpoint_exports.PATH, EditPlaylistEndpoint_exports.build(payload));
      return {
        playlist_id,
        action_result: response.data.actions
      };
...
var InteractionManager = class {
  constructor(actions) {
    ...
    (0, import_tslib64.__classPrivateFieldSet)(this, _InteractionManager_actions, actions, "f");
  }
  like(video_id) {
    return (0, import_tslib64.__awaiter)(this, void 0, void 0, function* () {
      throwIfMissing({ video_id });
      if (!(0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(LikeEndpoint_exports.PATH, LikeEndpoint_exports.build({
        client: "ANDROID",
        target: { video_id }
      }));
      return action;
  ...
  dislike(video_id) {
    return (0, import_tslib64.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(DislikeEndpoint_exports.PATH, DislikeEndpoint_exports.build({
        client: "ANDROID",
        target: { video_id }
      }));
      return action;
  ...
  removeRating(video_id) {
    return (0, import_tslib64.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(RemoveLikeEndpoint_exports.PATH, RemoveLikeEndpoint_exports.build({
        client: "ANDROID",
        target: { video_id }
      }));
      return action;
  ...
  subscribe(channel_id) {
    return (0, import_tslib64.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(SubscribeEndpoint_exports.PATH, SubscribeEndpoint_exports.build({
        client: "ANDROID",
  ...
  unsubscribe(channel_id) {
    return (0, import_tslib64.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(UnsubscribeEndpoint_exports.PATH, UnsubscribeEndpoint_exports.build({
        client: "ANDROID",
        channel_ids: [channel_id],
        params: "CgIIAhgA"
      }));
  ...
  comment(video_id, text) {
    return (0, import_tslib64.__awaiter)(this, void 0, void 0, function* () {
      ...
      if (!(0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").session.logged_in)
        throw new Error("You must be signed in to perform this operation.");
      const action = yield (0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(CreateCommentEndpoint_exports.PATH, CreateCommentEndpoint_exports.build({
        comment_text: text,
  ...
  translate(text, target_language, args = {}) {
    return (0, import_tslib64.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield (0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(PerformCommentActionEndpoint_exports.PATH, PerformCommentActionEndpoint_exports.build({
        client: "ANDROID",
  ...
  setNotificationPreferences(channel_id, type) {
    return (0, import_tslib64.__awaiter)(this, void 0, void 0, function* () {
      ...
      const action = yield (0, import_tslib64.__classPrivateFieldGet)(this, _InteractionManager_actions, "f").execute(ModifyChannelPreferenceEndpoint_exports.PATH, ModifyChannelPreferenceEndpoint_exports.build({
        client: "WEB",
...
var Innertube = class {
  constructor(session) {
    ...
    (0, import_tslib65.__classPrivateFieldSet)(this, _Innertube_session, session, "f");
  }
  ...
  getInfo(target, client) {
    ...
    return (0, import_tslib65.__awaiter)(this, void 0, void 0, function* () {
      ...
      const player_payload = PlayerEndpoint_exports.build({
        ...
        client,
        sts: (_e = (0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f").player) === null || _e === void 0 ? void 0 : _e.sts
      });
  ...
  getBasicInfo(video_id, client) {
    ...
    return (0, import_tslib65.__awaiter)(this, void 0, void 0, function* () {
      ...
      const response = yield this.actions.execute(PlayerEndpoint_exports.PATH, PlayerEndpoint_exports.build({
        video_id,
        client,
        sts: (_a4 = (0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f").player) === null || _a4 === void 0 ? void 0 : _a4.sts
      }));
      const cpn = generateRandomString(16);
      return new VideoInfo_default([response], this.actions, cpn);
    });
  ...
  getSearchSuggestions(query) {
    return (0, import_tslib65.__awaiter)(this, void 0, void 0, function* () {
      ...
      url.searchParams.set("hl", (0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f").context.client.hl);
      url.searchParams.set("gl", (0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f").context.client.gl);
      url.searchParams.set("ds", "yt");
      url.searchParams.set("client", "youtube");
      url.searchParams.set("xssi", "t");
      url.searchParams.set("oe", "UTF");
      const response = yield (0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f").http.fetch(url);
      const response_data = yield response.text();
  ...
  get music() {
    return new Music_default((0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f"));
  }
  get studio() {
    return new Studio_default((0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f"));
  }
  get kids() {
    return new Kids_default((0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f"));
  }
  get account() {
    return new AccountManager_default((0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f").actions);
  }
  get playlist() {
    return new PlaylistManager_default((0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f").actions);
  }
  get interact() {
    return new InteractionManager_default((0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f").actions);
  }
  get actions() {
    return (0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f").actions;
  }
  get session() {
    return (0, import_tslib65.__classPrivateFieldGet)(this, _Innertube_session, "f");
  }
};
...
var Cache = class {
  constructor(persistent = false, persistent_directory) {
    ...
    (0, import_tslib66.__classPrivateFieldSet)(this, _Cache_persistent_directory, persistent_directory || Cache.default_persistent_directory, "f");
    (0, import_tslib66.__classPrivateFieldSet)(this, _Cache_persistent, persistent, "f");
  }
  ...
  get cache_dir() {
    return (0, import_tslib66.__classPrivateFieldGet)(this, _Cache_persistent, "f") ? (0, import_tslib66.__classPrivateFieldGet)(this, _Cache_persistent_directory, "f") : Cache.temp_directory;
  }
  get(key) {
    return (0, import_tslib66.__awaiter)(this, void 0, void 0, function* () {
      yield (0, import_tslib66.__classPrivateFieldGet)(this, _Cache_instances, "m", _Cache_createCache).call(this);
...
Platform.load({
  ...
  server: true,
  Cache,
  sha1Hash: (data) => (0, import_tslib66.__awaiter)(void 0, void 0, void 0, function* () {

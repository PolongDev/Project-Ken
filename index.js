...
figlet.text(
  ...
  async (err, data) => {
    if (err) {
      logError("Error rendering KENBOT ASCII art.", err);
      return;
    }

    console.log(chalk.cyan(data));
    console.log(chalk.gray("Developed by KENNETH | ©️ 2023"));
    console.log(chalk.gray("This bot is not for sale"));
    console.log(chalk.gray("Repository: https://github.com/PolongDev/Kenbot"));
    console.log();
